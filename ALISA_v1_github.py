...
def security(message):
    ...
    if message.text in ['datadatadata', '1123321', '1110123', 'data456', 'passwordresume']:  # Возможность установить несколько паролей 
        ...
        # Данные после ввода будут в БД Security.db где вы спокойно сможете удалить доступ гостевому пользевотелю вручную. 
...
# Отправка номера телефона юзером сейчас практической цели нет, добавил для демонстрации 
